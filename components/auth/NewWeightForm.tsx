...
import { newWeight } from "@/actions/new-weight";

type Props = {};

export const NewWeightForm = (props: Props) => {
  ...
  return (
    <CardWrapper
      headerText="Update weight"
      headerLabel="Enter your new weight"
